...
num_channels = 32
weight = "data/isbnet_pretrain.pth"
...
model = dict(
    ...
    backbone=dict(
        ...
        num_planes=[num_channels * (i + 1) for i in range(7)],
        return_blocks=True
    ),
    decoder=dict(
...
hooks = [
    dict(type="CustomCheckpointLoader", keywords="module.", replacement="module.backbone."),
